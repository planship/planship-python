...
class BucketUsage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BucketUsage:
        """Create an instance of BucketUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BucketUsage.parse_obj(obj)

        _obj = BucketUsage.parse_obj({
            "usage": obj.get("usage"),
