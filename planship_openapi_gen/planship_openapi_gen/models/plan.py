...
class Plan(BaseModel):
    ...
    name: StrictStr = Field(..., description="Plan name")
    description: StrictStr = Field(..., description="Plan description")
    order: Optional[StrictInt] = Field(None, description="Plan display order")
    entitlements: conlist(PlanEntitlement) = Field(...)
    __properties = ["slug", "name", "description", "order", "entitlements"]
    ...
    def from_dict(cls, obj: dict) -> Plan:
        ...
        _obj = Plan.parse_obj({
            ...
            "order": obj.get("order"),
            "entitlements": [PlanEntitlement.from_dict(_item) for _item in obj.get("entitlements")] if obj.get("entitlements") is not None else None
        })
        return _obj
